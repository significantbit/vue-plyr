...
hiddenKeys$2[HIDDEN$1] = true;var defineProperty$6 = objectDefineProperty$1.f;
...
defineWellKnownSymbol$1('iterator');var createProperty$1 = function (object, key, value) {
...
});var getOwnPropertyNames$1 = objectGetOwnPropertyNamesExternal$1.f; // eslint-disable-next-line es/no-object-getownpropertynames -- required for testing
...
fixRegexpWellKnownSymbolLogic('split', 2, function (SPLIT, nativeSplit, maybeCallNative) {
  ...
  function (regexp, limit) {
    ...
    while (q < S.length) {
      ...
      if (z === null || (e = min$7(toLength$1(splitter.lastIndex + (UNSUPPORTED_Y$4 ? q : 0)), S.length)) === p) {
...
}, UNSUPPORTED_Y$4);var getOwnPropertyDescriptor$5 = objectGetOwnPropertyDescriptor$1.f; // eslint-disable-next-line es/no-string-prototype-startswith -- safe
...
if (descriptors && typeof NativeSymbol$1 == 'function' && (!('description' in NativeSymbol$1.prototype) || // Safari 12 bug
NativeSymbol$1().description !== undefined)) {
  var EmptyStringDescriptionStore$1 = {}; // wrap Symbol constructor for correct work with undefined description

  var SymbolWrapper$1 = function Symbol() {
    var description = arguments.length < 1 || arguments[0] === undefined ? undefined : String(arguments[0]);
    var result = this instanceof SymbolWrapper$1 ? new NativeSymbol$1(description) // in Edge 13, String(Symbol(undefined)) === 'Symbol(undefined)'
...
var check$2 = function check(it) {
  return it && it.Math == Math && it;
}; // https://github.com/zloirock/core-js/issues/86#issuecomment-115759028


var global_1$2 = // eslint-disable-next-line es/no-global-this -- safe
check$2((typeof globalThis === "undefined" ? "undefined" : _typeof(globalThis)) == 'object' && globalThis) || check$2((typeof window === "undefined" ? "undefined" : _typeof(window)) == 'object' && window) || // eslint-disable-next-line no-restricted-globals -- safe
check$2((typeof self === "undefined" ? "undefined" : _typeof(self)) == 'object' && self) || check$2(_typeof(commonjsGlobal$1) == 'object' && commonjsGlobal$1) || // eslint-disable-next-line no-new-func -- fallback
function () {
  return this;
}() || Function('return this')();

var fails$2 = function fails(exec) {
  try {
    return !!exec();
  } catch (error) {
    return true;
...
var NASHORN_BUG$2 = getOwnPropertyDescriptor$1$1 && !$propertyIsEnumerable$3.call({
  1: 2
}, 1); // `Object.prototype.propertyIsEnumerable` method implementation
// https://tc39.es/ecma262/#sec-object.prototype.propertyisenumerable

var f$4$1 = NASHORN_BUG$2 ? function propertyIsEnumerable(V) {
...
var indexedObject$2 = fails$2(function () {
  ...
  return classofRaw$2(it) == 'String' ? split$2.call(it, '') : Object(it);
} : Object; // `RequireObjectCoercible` abstract operation
// https://tc39.es/ecma262/#sec-requireobjectcoercible
...
var isObject$2 = function isObject$2(it) {
...
var toPrimitive$2 = function toPrimitive(input, PREFERRED_STRING) {
...
var has$1$1 = function has$1(it, key) {
  return hasOwnProperty$2.call(it, key);
};

var document$1$1 = global_1$2.document; // typeof document.createElement is 'object' in old IE

var EXISTS$2 = isObject$2(document$1$1) && isObject$2(document$1$1.createElement);
...
var f$3$1 = descriptors$2 ? $getOwnPropertyDescriptor$3 : function getOwnPropertyDescriptor(O, P) {
  ...
  if (has$1$1(O, P)) return createPropertyDescriptor$2(!objectPropertyIsEnumerable$2.f.call(O, P), O[P]);
};
var objectGetOwnPropertyDescriptor$2 = {
  f: f$3$1
};

var anObject$2 = function anObject(it) {
  if (!isObject$2(it)) {
    throw TypeError(String(it) + ' is not an object');
  }
...
var $defineProperty$3 = Object.defineProperty; // `Object.defineProperty` method
// https://tc39.es/ecma262/#sec-object.defineproperty

var f$2$1 = descriptors$2 ? $defineProperty$3 : function defineProperty(O, P, Attributes) {
  anObject$2(O);
  P = toPrimitive$2(P, true);
...
var setGlobal$2 = function setGlobal(key, value) {
  try {
    createNonEnumerableProperty$2(global_1$2, key, value);
  } catch (error) {
...
var store$1$1 = global_1$2[SHARED$2] || setGlobal$2(SHARED$2, {});
var sharedStore$2 = store$1$1;
var functionToString$2 = Function.toString; // this helper broken in `3.4.1-3.4.4`, so we can't use `shared` helper

if (typeof sharedStore$2.inspectSource != 'function') {
...
var WeakMap$2$1 = global_1$2.WeakMap;
var nativeWeakMap$2 = typeof WeakMap$2$1 === 'function' && /native code/.test(inspectSource$2(WeakMap$2$1));
var isPure$1 = false;
var shared$2 = createCommonjsModule$1(function (module) {
  (module.exports = function (key, value) {
...
var set$2, get$2, has$4;

var enforce$2 = function enforce(it) {
  return has$4(it) ? get$2(it) : set$2(it, {});
};
...
if (nativeWeakMap$2) {
  var store$4 = sharedStore$2.state || (sharedStore$2.state = new WeakMap$1$1());
  var wmget$2 = store$4.get;
  var wmhas$2 = store$4.has;
  var wmset$2 = store$4.set;

  set$2 = function set(it, metadata) {
    metadata.facade = it;
    wmset$2.call(store$4, it, metadata);
    return metadata;
  };

  get$2 = function get(it) {
    return wmget$2.call(store$4, it) || {};
  };

  has$4 = function has(it) {
    return wmhas$2.call(store$4, it);
  };
} else {
  var STATE$2 = sharedKey$2('state');
  hiddenKeys$1$1[STATE$2] = true;
  ...
  get$2 = function get(it) {
    return has$1$1(it, STATE$2) ? it[STATE$2] : {};
  };

  has$4 = function has(it) {
    return has$1$1(it, STATE$2);
  };
}
...
var redefine$2 = createCommonjsModule$1(function (module) {
  ...
  (module.exports = function (O, key, value, options) {
    ...
    if (typeof value == 'function') {
      if (typeof key == 'string' && !has$1$1(value, 'name')) {
    ...
    if (O === global_1$2) {
      if (simple) O[key] = value;else setGlobal$2(key, value);
      return;
    } else if (!unsafe) {
      delete O[key];
    } else if (!noTargetGet && O[key]) {
...
var getBuiltIn$2 = function getBuiltIn(namespace, method) {
  return arguments.length < 2 ? aFunction$1$1(path$2[namespace]) || aFunction$1$1(global_1$2[namespace]) : path$2[namespace] && path$2[namespace][method] || global_1$2[namespace] && global_1$2[namespace][method];
};

var ceil$3 = Math.ceil;
var floor$3$1 = Math.floor; // `ToInteger` abstract operation
// https://tc39.es/ecma262/#sec-tointeger

var toInteger$2 = function toInteger(argument) {
  return isNaN(argument = +argument) ? 0 : (argument > 0 ? floor$3$1 : ceil$3)(argument);
};
...
var toLength$2 = function toLength(argument) {
  return argument > 0 ? min$2$1(toInteger$2(argument), 0x1FFFFFFFFFFFFF) : 0; // 2 ** 53 - 1 == 9007199254740991
};
...
var toAbsoluteIndex$2 = function toAbsoluteIndex(index, length) {
  ...
  return integer < 0 ? max$1$1(integer + length, 0) : min$1$1(integer, length);
}; // `Array.prototype.{ indexOf, includes }` methods implementation


var createMethod$1$1 = function createMethod$1(IS_INCLUDES) {
  return function ($this, el, fromIndex) {
...
var objectKeysInternal$2 = function objectKeysInternal(object, names) {
  ...
  for (key in O) {
    !has$1$1(hiddenKeys$1$1, key) && has$1$1(O, key) && result.push(key);
  } // Don't enum bug & hidden keys


  while (names.length > i) {
    if (has$1$1(O, key = names[i++])) {
...
var f$1$1 = Object.getOwnPropertyNames || function getOwnPropertyNames(O) {
  return objectKeysInternal$2(O, hiddenKeys$4);
};
...
var f$e = Object.getOwnPropertySymbols;
...
var isForced$2 = function isForced(feature, detection) {
  ...
  return value == POLYFILL$2 ? true : value == NATIVE$2 ? false : typeof detection == 'function' ? fails$2(detection) : !!detection;
};
...
var _export$2 = function _export(options, source) {
  var TARGET = options.target;
  var GLOBAL = options.global;
  var STATIC = options.stat;
  var FORCED, target, key, targetProperty, sourceProperty, descriptor;
  ...
  if (GLOBAL) {
    ...
    target = global_1$2[TARGET] || setGlobal$2(TARGET, {});
  } else {
  ...
  if (target) for (key in source) {
    ...
    FORCED = isForced_1$2(GLOBAL ? key : TARGET + (STATIC ? '.' : '#') + key, options.forced); // contained in target
...
var regexpFlags$2 = function regexpFlags() {
...
var UNSUPPORTED_Y$1$1 = fails$2(function () {
  // babel-minify transpiles RegExp('a', 'y') -> /a/y and it causes SyntaxError
  var re = RE$1('a', 'y');
  re.lastIndex = 2;
  return re.exec('abcd') != null;
});
var BROKEN_CARET$1 = fails$2(function () {
  // https://bugzilla.mozilla.org/show_bug.cgi?id=773687
  var re = RE$1('^r', 'gy');
  re.lastIndex = 2;
  return re.exec('str') != null;
...
var regexpStickyHelpers$1 = {
  UNSUPPORTED_Y: UNSUPPORTED_Y$1$1,
...
var PATCH$1 = UPDATES_LAST_INDEX_WRONG$1 || NPCG_INCLUDED$1 || UNSUPPORTED_Y$5;
...
var regexpExec$1 = patchedExec$1; // `RegExp.prototype.exec` method
...
var engineIsNode$1 = classofRaw$2(global_1$2.process) == 'process';
...
var engineV8Version$2 = version$2 && +version$2; // eslint-disable-next-line es/no-object-getownpropertysymbols -- required for testing

var nativeSymbol$2 = !!Object.getOwnPropertySymbols && !fails$2(function () {
  // eslint-disable-next-line es/no-symbol -- required for testing
  return !Symbol.sham && ( // Chrome 38 Symbol has incorrect toString conversion
  // Chrome 38-40 symbols are not inherited from DOM collections prototypes to instances
  engineIsNode$1 ? engineV8Version$2 === 38 : engineV8Version$2 > 37 && engineV8Version$2 < 41);
});
/* eslint-disable es/no-symbol -- required for testing */

var useSymbolAsUid$2 = nativeSymbol$2 && !Symbol.sham && _typeof(Symbol.iterator) == 'symbol';
var WellKnownSymbolsStore$4 = shared$2('wks');
var Symbol$1$1 = global_1$2.Symbol;
var createWellKnownSymbol$2 = useSymbolAsUid$2 ? Symbol$1$1 : Symbol$1$1 && Symbol$1$1.withoutSetter || uid$2;

var wellKnownSymbol$2 = function wellKnownSymbol(name) {
  if (!has$1$1(WellKnownSymbolsStore$4, name) || !(nativeSymbol$2 || typeof WellKnownSymbolsStore$4[name] == 'string')) {
    if (nativeSymbol$2 && has$1$1(Symbol$1$1, name)) {
...
var REPLACE$1 = wellKnownSymbol$2('replace'); // Safari <= 13.0.3(?) substitutes nth capture where n>m with an empty string
...
var SPLIT_WORKS_WITH_OVERWRITTEN_EXEC$1 = !fails$2(function () {
  // eslint-disable-next-line regexp/no-empty-group -- required for testing
  var re = /(?:)/;
  var originalExec = re.exec;
...
var fixRegexpWellKnownSymbolLogic$1 = function fixRegexpWellKnownSymbolLogic(KEY, length, exec, sham) {
  ...
  var DELEGATES_TO_EXEC = DELEGATES_TO_SYMBOL && !fails$2(function () {
    ...
    if (KEY === 'split') {
      ...
      re.constructor[SPECIES$9] = function () {
        return re;
      };
  ...
  if (!DELEGATES_TO_SYMBOL || !DELEGATES_TO_EXEC || KEY === 'replace' && !(REPLACE_SUPPORTS_NAMED_GROUPS$1 && REPLACE_KEEPS_$0$1 && !REGEXP_REPLACE_SUBSTITUTES_UNDEFINED_CAPTURE$1) || KEY === 'split' && !SPLIT_WORKS_WITH_OVERWRITTEN_EXEC$1) {
    ...
    redefine$2(RegExp.prototype, SYMBOL, length == 2 // 21.2.5.8 RegExp.prototype[@@replace](string, replaceValue)
    // 21.2.5.11 RegExp.prototype[@@split](string, limit)
    ? function (string, arg) {
      return regexMethod.call(string, this, arg);
    } // 21.2.5.6 RegExp.prototype[@@match](string)
  ...
  if (sham) createNonEnumerableProperty$2(RegExp.prototype[SYMBOL], 'sham', true);
}; // `String.prototype.{ codePointAt, at }` methods implementation


var createMethod$9 = function createMethod(CONVERT_TO_STRING) {
  return function ($this, pos) {
...
var charAt$1$1 = stringMultibyte$2.charAt; // `AdvanceStringIndex` abstract operation
// https://tc39.es/ecma262/#sec-advancestringindex
...
var replace$1$1 = ''.replace;
var SUBSTITUTION_SYMBOLS$1 = /\$([$&'`]|\d{1,2}|<[^>]*>)/g;
var SUBSTITUTION_SYMBOLS_NO_NAMED$1 = /\$([$&'`]|\d{1,2})/g; // https://tc39.es/ecma262/#sec-getsubstitution
...
var getSubstitution$1 = function getSubstitution(matched, str, position, captures, namedCaptures, replacement) {
  ...
  return replace$1$1.call(replacement, symbols, function (match, ch) {
    var capture;
...
fixRegexpWellKnownSymbolLogic$1('replace', 2, function (REPLACE, nativeReplace, maybeCallNative, reason) {
  ...
  function (regexp, replaceValue) {
    ...
    for (var i = 0; i < results.length; i++) {
      result = results[i];
      var matched = String(result[0]);
      var position = max$6(min$9(toInteger$2(result.index), S.length), 0);
      var captures = []; // NOTE: This is equivalent to
      //   captures = result.slice(1).map(maybeToString)
      // but for some reason `nativeSlice.call(result, 1, result.length)` (called in
      // the slice polyfill when slicing native arrays) "doesn't work" in safari 9 and
...
var ObjectPrototype$4 = Object.prototype; // `Object.getPrototypeOf` method
// https://tc39.es/ecma262/#sec-object.getprototypeof
// eslint-disable-next-line es/no-object-getprototypeof -- safe

var objectGetPrototypeOf$2 = correctPrototypeGetter$2 ? Object.getPrototypeOf : function (O) {
  O = toObject$2(O);
  if (has$1$1(O, IE_PROTO$1$1)) return O[IE_PROTO$1$1];
...
var ITERATOR$5$1 = wellKnownSymbol$2('iterator');
...
var IteratorPrototype$2$1, PrototypeOfArrayIteratorPrototype$2, arrayIterator$2;
/* eslint-disable es/no-array-prototype-keys -- safe */

if ([].keys) {
  arrayIterator$2 = [].keys(); // Safari 8 has buggy iterators w/o `next`

  if (!('next' in arrayIterator$2)) BUGGY_SAFARI_ITERATORS$1$1 = true;else {
    PrototypeOfArrayIteratorPrototype$2 = objectGetPrototypeOf$2(objectGetPrototypeOf$2(arrayIterator$2));
    if (PrototypeOfArrayIteratorPrototype$2 !== Object.prototype) IteratorPrototype$2$1 = PrototypeOfArrayIteratorPrototype$2;
  }
}

var NEW_ITERATOR_PROTOTYPE$1 = IteratorPrototype$2$1 == undefined || fails$2(function () {
  var test = {}; // FF44- legacy iterators case

  return IteratorPrototype$2$1[ITERATOR$5$1].call(test) !== test;
});
if (NEW_ITERATOR_PROTOTYPE$1) IteratorPrototype$2$1 = {}; // 25.1.2.1.1 %IteratorPrototype%[@@iterator]()

if (!has$1$1(IteratorPrototype$2$1, ITERATOR$5$1)) {
  createNonEnumerableProperty$2(IteratorPrototype$2$1, ITERATOR$5$1, returnThis$2$1);
}
...
var objectDefineProperties$2 = descriptors$2 ? Object.defineProperties : function defineProperties(O, Properties) {
  anObject$2(O);
  ...
  while (length > index) {
    objectDefineProperty$2.f(O, key = keys[index++], Properties[key]);
  }
...
var EmptyConstructor$2 = function EmptyConstructor() {
  /* empty */
};

var scriptTag$2 = function scriptTag(content) {
  return LT$2 + SCRIPT$2 + GT$2 + content + LT$2 + '/' + SCRIPT$2 + GT$2;
}; // Create object with fake `null` prototype: use ActiveX Object with cleared prototype


var NullProtoObjectViaActiveX$2 = function NullProtoObjectViaActiveX(activeXDocument) {
...
var NullProtoObjectViaIFrame$2 = function NullProtoObjectViaIFrame() {
  // Thrash, waste and sodomy: IE GC bug
...
var _NullProtoObject = function NullProtoObject() {
  ...
  _NullProtoObject = activeXDocument$2 ? NullProtoObjectViaActiveX$2(activeXDocument$2) : NullProtoObjectViaIFrame$2();
  var length = enumBugKeys$2.length;

  while (length--) {
    delete _NullProtoObject[PROTOTYPE$4][enumBugKeys$2[length]];
  }

  return _NullProtoObject();
};

hiddenKeys$1$1[IE_PROTO$4] = true; // `Object.create` method
// https://tc39.es/ecma262/#sec-object.create
...
var objectCreate$2 = Object.create || function create(O, Properties) {
  ...
  if (O !== null) {
    EmptyConstructor$2[PROTOTYPE$4] = anObject$2(O);
    result = new EmptyConstructor$2();
    EmptyConstructor$2[PROTOTYPE$4] = null; // add "__proto__" for Object.getPrototypeOf polyfill
...
var defineProperty$1$1 = objectDefineProperty$2.f;
...
var setToStringTag$2 = function setToStringTag(it, TAG, STATIC) {
  if (it && !has$1$1(it = STATIC ? it : it.prototype, TO_STRING_TAG$2$1)) {
    defineProperty$1$1(it, TO_STRING_TAG$2$1, {
      configurable: true,
      value: TAG
    });
  }
...
var iterators$2 = {};
var IteratorPrototype$1$1 = iteratorsCore$2.IteratorPrototype;

var returnThis$1$1 = function returnThis$1() {
  return this;
};

var createIteratorConstructor$2 = function createIteratorConstructor(IteratorConstructor, NAME, next) {
  var TO_STRING_TAG = NAME + ' Iterator';
  IteratorConstructor.prototype = objectCreate$2(IteratorPrototype$1$1, {
    next: createPropertyDescriptor$2(1, next)
  });
  setToStringTag$2(IteratorConstructor, TO_STRING_TAG, false);
  iterators$2[TO_STRING_TAG] = returnThis$1$1;
  return IteratorConstructor;
};
...
var IteratorPrototype$6 = iteratorsCore$2.IteratorPrototype;
var BUGGY_SAFARI_ITERATORS$4 = iteratorsCore$2.BUGGY_SAFARI_ITERATORS;
var ITERATOR$4$1 = wellKnownSymbol$2('iterator');
var KEYS$2 = 'keys';
var VALUES$2 = 'values';
var ENTRIES$2 = 'entries';

var returnThis$6 = function returnThis() {
  return this;
};
...
var defineIterator$2 = function defineIterator(Iterable, NAME, IteratorConstructor, next, DEFAULT, IS_SET, FORCED) {
  ...
  var getIterationMethod = function getIterationMethod(KIND) {
    if (KIND === DEFAULT && defaultIterator) return defaultIterator;
    if (!BUGGY_SAFARI_ITERATORS$4 && KIND in IterablePrototype) return IterablePrototype[KIND];
  ...
  var INCORRECT_VALUES_NAME = false;
  var IterablePrototype = Iterable.prototype;
  var nativeIterator = IterablePrototype[ITERATOR$4$1] || IterablePrototype['@@iterator'] || DEFAULT && IterablePrototype[DEFAULT];
  var defaultIterator = !BUGGY_SAFARI_ITERATORS$4 && nativeIterator || getIterationMethod(DEFAULT);
  var anyNativeIterator = NAME == 'Array' ? IterablePrototype.entries || nativeIterator : nativeIterator;
  var CurrentIteratorPrototype, methods, KEY; // fix native
  ...
  if (anyNativeIterator) {
    ...
    if (IteratorPrototype$6 !== Object.prototype && CurrentIteratorPrototype.next) {
      if (objectGetPrototypeOf$2(CurrentIteratorPrototype) !== IteratorPrototype$6) {
        if (objectSetPrototypeOf$2) {
          objectSetPrototypeOf$2(CurrentIteratorPrototype, IteratorPrototype$6);
        } else if (typeof CurrentIteratorPrototype[ITERATOR$4$1] != 'function') {
          createNonEnumerableProperty$2(CurrentIteratorPrototype, ITERATOR$4$1, returnThis$6);
        }
      } // Set @@toStringTag to native iterators
  ...
  if (DEFAULT == VALUES$2 && nativeIterator && nativeIterator.name !== VALUES$2) {
    INCORRECT_VALUES_NAME = true;
  ...
  if (IterablePrototype[ITERATOR$4$1] !== defaultIterator) {
    createNonEnumerableProperty$2(IterablePrototype, ITERATOR$4$1, defaultIterator);
  }
  ...
  if (DEFAULT) {
    ...
    if (FORCED) for (KEY in methods) {
      if (BUGGY_SAFARI_ITERATORS$4 || INCORRECT_VALUES_NAME || !(KEY in IterablePrototype)) {
        redefine$2(IterablePrototype, KEY, methods[KEY]);
      }
    } else _export$2({
      target: NAME,
      proto: true,
      forced: BUGGY_SAFARI_ITERATORS$4 || INCORRECT_VALUES_NAME
    }, methods);
  }
...
var setInternalState$3$1 = internalState$2.set;
var getInternalState$1$1 = internalState$2.getterFor(STRING_ITERATOR$2); // `String.prototype[@@iterator]` method
// https://tc39.es/ecma262/#sec-string.prototype-@@iterator
...
var ITERATOR$3$1 = wellKnownSymbol$2('iterator');
var nativeUrl$1 = !fails$2(function () {
  var url = new URL('b?a=1&b=2&c=3', 'http://a');
  var searchParams = url.searchParams;
  var result = '';
  url.pathname = 'c%20d';
  ...
  return isPure$1 && !url.toJSON || !searchParams.sort || url.href !== 'http://a/c%20d?a=1&c=3' || searchParams.get('c') !== '3' || String(new URLSearchParams('?a=1')) !== 'a=1' || !searchParams[ITERATOR$3$1] // throws in Edge
  || new URL('https://a@b').username !== 'a' || new URLSearchParams(new URLSearchParams('a=b')).get('a') !== 'b' // not punycoded in Edge
  || new URL('http://тест').host !== 'xn--e1aybc' // not escaped in Chrome 62-
  || new URL('http://a#б').hash !== '#%D0%B1' // fails in Chrome 66-
  || result !== 'a1c3' // throws in Safari
...
var $assign$1 = Object.assign; // eslint-disable-next-line es/no-object-defineproperty -- required for testing

var defineProperty$c = Object.defineProperty; // `Object.assign` method
// https://tc39.es/ecma262/#sec-object.assign

var objectAssign$1 = !$assign$1 || fails$2(function () {
  // should have correct order of operations (Edge bug)
  if (descriptors$2 && $assign$1({
    b: 1
  }, $assign$1(defineProperty$c({}, 'a', {
    enumerable: true,
    get: function get() {
  ...
  return $assign$1({}, A)[symbol] != 7 || objectKeys$2($assign$1({}, B)).join('') != alphabet;
}) ? function assign(target, source) {
  // eslint-disable-line no-unused-vars -- required for `.length`
  ...
  var index = 1;
  var getOwnPropertySymbols = objectGetOwnPropertySymbols$2.f;
  var propertyIsEnumerable = objectPropertyIsEnumerable$2.f;
...
var aFunction$4 = function aFunction(it) {
  if (typeof it != 'function') {
    throw TypeError(String(it) + ' is not a function');
  }
...
var functionBindContext$2 = function functionBindContext(fn, that, length) {
  aFunction$4(fn);
  if (that === undefined) return fn;
...
var callWithSafeIterationClosing$2 = function callWithSafeIterationClosing(iterator, fn, value, ENTRIES) {
  try {
    return ENTRIES ? fn(anObject$2(value)[0], value[1]) : fn(value); // 7.4.6 IteratorClose(iterator, completion)
  } catch (error) {
...
var ArrayPrototype$1$1 = Array.prototype; // check on default Array iterator

var isArrayIteratorMethod$2 = function isArrayIteratorMethod(it) {
  return it !== undefined && (iterators$2.Array === it || ArrayPrototype$1$1[ITERATOR$2$1] === it);
};

var createProperty$2 = function createProperty(object, key, value) {
  var propertyKey = toPrimitive$2(key);
  if (propertyKey in object) objectDefineProperty$2.f(object, propertyKey, createPropertyDescriptor$2(0, value));else object[propertyKey] = value;
};

var TO_STRING_TAG$1$1 = wellKnownSymbol$2('toStringTag');
var test$2 = {};
test$2[TO_STRING_TAG$1$1] = 'z';
var toStringTagSupport$2 = String(test$2) === '[object z]';
var TO_STRING_TAG$8 = wellKnownSymbol$2('toStringTag'); // ES3 wrong here

var CORRECT_ARGUMENTS$2 = classofRaw$2(function () {
  return arguments;
}()) == 'Arguments'; // fallback for IE11 Script Access Denied error

var tryGet$2 = function tryGet(it, key) {
  try {
    return it[key];
  } catch (error) {
    /* empty */
...
var classof$2 = toStringTagSupport$2 ? classofRaw$2 : function (it) {
  var O, tag, result;
  return it === undefined ? 'Undefined' : it === null ? 'Null' // @@toStringTag case
  : typeof (tag = tryGet$2(O = Object(it), TO_STRING_TAG$8)) == 'string' ? tag // builtinTag case
  : CORRECT_ARGUMENTS$2 ? classofRaw$2(O) // ES3 arguments fallback
  : (result = classofRaw$2(O)) == 'Object' && typeof O.callee == 'function' ? 'Arguments' : result;
};
var ITERATOR$1$1 = wellKnownSymbol$2('iterator');

var getIteratorMethod$2 = function getIteratorMethod(it) {
  if (it != undefined) return it[ITERATOR$1$1] || it['@@iterator'] || iterators$2[classof$2(it)];
}; // `Array.from` method implementation
// https://tc39.es/ecma262/#sec-array.from


var arrayFrom$2 = function from(arrayLike
/* , mapfn = undefined, thisArg = undefined */
) {
...
var ArrayPrototype$4 = Array.prototype; // Array.prototype[@@unscopables]
// https://tc39.es/ecma262/#sec-array.prototype-@@unscopables

if (ArrayPrototype$4[UNSCOPABLES$2] == undefined) {
  objectDefineProperty$2.f(ArrayPrototype$4, UNSCOPABLES$2, {
    configurable: true,
...
var addToUnscopables$2 = function addToUnscopables(key) {
  ArrayPrototype$4[UNSCOPABLES$2][key] = true;
};

var ARRAY_ITERATOR$2 = 'Array Iterator';
var setInternalState$2$1 = internalState$2.set;
var getInternalState$6 = internalState$2.getterFor(ARRAY_ITERATOR$2); // `Array.prototype.entries` method
// https://tc39.es/ecma262/#sec-array.prototype.entries
// `Array.prototype.keys` method
// https://tc39.es/ecma262/#sec-array.prototype.keys
// `Array.prototype.values` method
...
var redefineAll$1 = function redefineAll(target, src, options) {
  for (var key in src) {
    redefine$2(target, key, src[key], options);
  }
...
var setInternalState$1$1 = internalState$2.set;
var getInternalParamsState$1 = internalState$2.getterFor(URL_SEARCH_PARAMS$1);
var getInternalIteratorState$1 = internalState$2.getterFor(URL_SEARCH_PARAMS_ITERATOR$1);
var plus$1 = /\+/g;
...
var replacer$1 = function replacer(match) {
  return replace$2[match];
};

var serialize$1 = function serialize(it) {
...
var URLSearchParamsIterator$1 = createIteratorConstructor$2(function Iterator(params, kind) {
  ...
  if (init !== undefined) {
    if (isObject$2(init)) {
      ...
      if (typeof iteratorMethod === 'function') {
        ...
        if (has$1$1(init, key)) entries.push({
          key: key,
          value: init[key] + ''
        });
      }
...
redefineAll$1(URLSearchParamsPrototype$1, {
  ...
  /* , thisArg */
    ...
    var entries = getInternalParamsState$1(this).entries;
    var boundFunction = functionBindContext$2(callback, arguments.length > 1 ? arguments[1] : undefined, 3);
    var index = 0;
    var entry;
...
redefine$2(URLSearchParamsPrototype$1, ITERATOR$e, URLSearchParamsPrototype$1.entries); // `URLSearchParams.prototype.toString` method
// https://url.spec.whatwg.org/#urlsearchparams-stringification-behavior

redefine$2(URLSearchParamsPrototype$1, 'toString', function toString() {
  var entries = getInternalParamsState$1(this).entries;
  var result = [];
  var index = 0;
  var entry;
...
setToStringTag$2(URLSearchParamsConstructor$1, URL_SEARCH_PARAMS$1);
    ...
    /* , init */
      ...
      if (arguments.length > 1) {
        ...
        if (isObject$2(init)) {
          ...
          if (classof$2(body) === URL_SEARCH_PARAMS$1) {
...
var codeAt$1 = stringMultibyte$2.codeAt;
var NativeURL$1 = global_1$2.URL;
...
var getInternalURLState$1 = internalState$2.getterFor('URL');
...
var percentEncode$1 = function percentEncode(char, set) {
  var code = codeAt$1(char, 0);
  return code > 0x20 && code < 0x7F && !has$1$1(set, char) ? char : encodeURIComponent(char);
};
...
var isSpecial$1 = function isSpecial(url) {
  return has$1$1(specialSchemes$1, url.scheme);
};
...
var cannotHaveUsernamePasswordPort$1 = function cannotHaveUsernamePasswordPort(url) {
  return !url.host || url.cannotBeABaseURL || url.scheme == 'file';
};

var isWindowsDriveLetter$1 = function isWindowsDriveLetter(string, normalized) {
  var second;
  return string.length == 2 && ALPHA$1.test(string.charAt(0)) && ((second = string.charAt(1)) == ':' || !normalized && second == '|');
};

var startsWithWindowsDriveLetter$1 = function startsWithWindowsDriveLetter(string) {
  var third;
  return string.length > 1 && isWindowsDriveLetter$1(string.slice(0, 2)) && (string.length == 2 || (third = string.charAt(2)) === '/' || third === '\\' || third === '?' || third === '#');
};
    ...
    switch (state) {
      ...
      case SCHEME$1:
        if (char && (ALPHANUMERIC$1.test(char) || char == '+' || char == '-' || char == '.')) {
          ...
          if (stateOverride && (isSpecial$1(url) != has$1$1(specialSchemes$1, buffer) || buffer == 'file' && (includesCredentials$1(url) || url.port !== null) || url.scheme == 'file' && !url.host)) return;
          url.scheme = buffer;
      ...
      case AUTHORITY$1:
        if (char == '@') {
          if (seenAt) buffer = '%40' + buffer;
          seenAt = true;
          bufferCodePoints = arrayFrom$2(buffer);
          ...
          buffer = '';
        } else if (char == EOF$1 || char == '/' || char == '?' || char == '#' || char == '\\' && isSpecial$1(url)) {
          if (seenAt && buffer == '') return INVALID_AUTHORITY$1;
          pointer -= arrayFrom$2(buffer).length + 1;
          buffer = '';
          state = HOST$1;
        } else buffer += char;
      ...
      case PORT$1:
        if (DIGIT$1.test(char)) {
          buffer += char;
        } else if (char == EOF$1 || char == '/' || char == '?' || char == '#' || char == '\\' && isSpecial$1(url) || stateOverride) {
          if (buffer != '') {
            var port = parseInt(buffer, 10);
      ...
      case FILE$1:
        url.scheme = 'file';
        if (char == '/' || char == '\\') state = FILE_SLASH$1;else if (base && base.scheme == 'file') {
          if (char == EOF$1) {
            url.host = base.host;
            url.path = base.path.slice();
            url.query = base.query;
      ...
      case FILE_SLASH$1:
        ...
        if (base && base.scheme == 'file' && !startsWithWindowsDriveLetter$1(codePoints.slice(pointer).join(''))) {
          if (isWindowsDriveLetter$1(base.path[0], true)) url.path.push(base.path[0]);else url.host = base.host;
        }
      ...
      case PATH$1:
        if (char == EOF$1 || char == '/' || char == '\\' && isSpecial$1(url) || !stateOverride && (char == '?' || char == '#')) {
      ...
      case QUERY$1:
        if (!stateOverride && char == '#') {
          ...
          if (char == "'" && isSpecial$1(url)) url.query += '%27';else if (char == '#') url.query += '%23';else url.query += percentEncode$1(char, C0ControlPercentEncodeSet$1);
        }
...
var URLConstructor$1 = function URL(url
/* , base */
) {
  ...
  if (base !== undefined) {
    if (base instanceof URLConstructor$1) baseState = getInternalURLState$1(base);else {
...
var getHost$1 = function getHost$1() {
  var url = getInternalURLState$1(this);
  var host = url.host;
  var port = url.port;
  return host === null ? '' : port === null ? serializeHost$1(host) : serializeHost$1(host) + ':' + port;
};
...
if (descriptors$2) {
  objectDefineProperties$2(URLPrototype$1, {
    // `URL.prototype.href` accessors pair
    // https://url.spec.whatwg.org/#dom-url-href
    ...
    username: accessorDescriptor$1(getUsername$1, function (username) {
      var url = getInternalURLState$1(this);
      var codePoints = arrayFrom$2(String(username));
    ...
    password: accessorDescriptor$1(getPassword$1, function (password) {
      var url = getInternalURLState$1(this);
      var codePoints = arrayFrom$2(String(password));
      if (cannotHaveUsernamePasswordPort$1(url)) return;
      url.password = '';
    ...
    port: accessorDescriptor$1(getPort$1, function (port) {
      ...
      if (cannotHaveUsernamePasswordPort$1(url)) return;
      port = String(port);
      if (port == '') url.port = null;else parseURL$1(url, port, PORT$1);
    }),
    // `URL.prototype.pathname` accessors pair
    // https://url.spec.whatwg.org/#dom-url-pathname
...
redefine$2(URLPrototype$1, 'toJSON', function toJSON() {
...
redefine$2(URLPrototype$1, 'toString', function toString() {
  return serializeURL$1.call(this);
}, {
  enumerable: true
});
...
if (NativeURL$1) {
  ...
  if (nativeCreateObjectURL$1) redefine$2(URLConstructor$1, 'createObjectURL', function createObjectURL(blob) {
    return nativeCreateObjectURL$1.apply(NativeURL$1, arguments);
  }); // `URL.revokeObjectURL` method
  // https://developer.mozilla.org/en-US/docs/Web/API/URL/revokeObjectURL
  // eslint-disable-next-line no-unused-vars -- required for `.length`

  if (nativeRevokeObjectURL$1) redefine$2(URLConstructor$1, 'revokeObjectURL', function revokeObjectURL(url) {
    return nativeRevokeObjectURL$1.apply(NativeURL$1, arguments);
  });
}

setToStringTag$2(URLConstructor$1, 'URL');
...
var isEmpty = function isEmpty(input) {
  return isNullOrUndefined(input) || (isString(input) || isArray$2(input) || isNodeList(input)) && !input.length || isObject$3(input) && !Object.keys(input).length;
};
...
var standardRatios = [[1, 1], [4, 3], [3, 4], [5, 4], [4, 5], [3, 2], [2, 3], [16, 10], [10, 16], [16, 9], [9, 16], [21, 9], [9, 21], [32, 9], [9, 32]].reduce(function (out, _ref5) {
  ...
  return _objectSpread2(_objectSpread2({}, out), {}, _defineProperty({}, x / y, [x, y]));
  ...
  _createClass(Storage, null, [{
    ...
    get: function get() {
      try {
        ...
        var _test = '___test'; // Try to use it (it might be disabled, e.g. user is in private mode)
  ...
  if (!hasId || !exists()) {
    ...
    if (useStorage) {
      ...
      if (isCached) {
        ...
        update(container, _data.content);
      }
    } // Get the sprite
...
var controls = {
  ...
  createMenuItem: function createMenuItem(_ref9) {
    ...
    this.listeners.bind(menuItem, 'click keyup', function (event) {
      ...
      controls.showMenuPanel.call(_this9, 'home', is.keyboardEvent(event));
    }, type, false);
  ...
  updateProgress: function updateProgress(event) {
    ...
    var setProgress = function setProgress(target, input) {
      ...
      var progress = is.element(target) ? target : _this10.elements.display.buffer; // Update value and label
  ...
  updateSeekTooltip: function updateSeekTooltip(event) {
    ...
    var toggle = function toggle(show) {
      return toggleClass(_this11.elements.display.seekTooltip, visible, show);
    }; // Hide on touch
  ...
  create: function create(data) {
    ...
    dedupe(is.array(this.config.controls) ? this.config.controls : []).forEach(function (control) {
      ...
      if (control === 'settings' && !is.empty(_this16.config.settings)) {
      ...
      if (control === 'download') {
        ...
        if (!is.url(download) && _this16.isEmbed) {
          extend(_attributes, {
  ...
  inject: function inject() {
    ...
    if (this.config.tooltips.controls) {
      ...
      Array.from(labels).forEach(function (label) {
        toggleClass(label, _this17.config.classNames.hidden, false);
        toggleClass(label, _this17.config.classNames.tooltip, true);
      });
    }
  }
};
...
function buildUrlParams(input) {
  ...
  if (is.object(input)) {
    Object.entries(input).forEach(function (_ref12) {
...
var captions = {
  ...
  update: function update() {
    ...
    if (this.isHTML5 && this.isVideo) {
      tracks.filter(function (track) {
        ...
        _this18.debug.log('Track added', track); // Attempt to store if the original dom element was "default"
        ...
        on.call(_this18, track, 'cuechange', function () {
  ...
  toggle: function toggle(input) {
    ...
    setTimeout(function () {
      if (active && _this19.captions.toggled) {
  ...
  set: function set(index) {
    ...
    if (this.captions.currentTrack !== index) {
      ...
      var _ref14 = track || {},
          language = _ref14.language; // Store reference to node for invalidation on remove
  ...
  getTracks: function getTracks() {
    ...
    return tracks.filter(function (track) {
      return !_this20.isHTML5 || update || _this20.captions.meta.has(track);
  ...
  findTrack: function findTrack(languages) {
    ...
    var sortIsDefault = function sortIsDefault(track) {
      return Number((_this21.captions.meta.get(track) || {}).default);
    };
...
var Fullscreen = /*#__PURE__*/function () {
  function Fullscreen(player) {
    ...
    _defineProperty$1(this, "onChange", function () {
      ...
      var button = _this22.player.elements.buttons.fullscreen;

      if (is.element(button)) {
        button.pressed = _this22.active;
      } // Always trigger events on the plyr / media element (not a fullscreen container) and let them bubble up


      var target = _this22.target === _this22.player.media ? _this22.target : _this22.player.elements.container; // Trigger an event

      triggerEvent.call(_this22.player, target, _this22.active ? 'enterfullscreen' : 'exitfullscreen', true);
    });
    ...
    _defineProperty$1(this, "toggleFallback", function () {
      ...
      if (toggle) {
        ...
        window.scrollTo(_this22.scrollPosition.x, _this22.scrollPosition.y);
      } // Toggle scroll


      document.body.style.overflow = toggle ? 'hidden' : ''; // Toggle class hook

      toggleClass(_this22.target, _this22.player.config.classNames.fullscreen.fallback, toggle); // Force full viewport on iPhone X+
      ...
      if (browser.isIos) {
        ...
        if (toggle) {
          _this22.cleanupViewport = !hasProperty;

          if (!hasProperty) {
            viewport.content += ",".concat(property);
          }
        } else if (_this22.cleanupViewport) {
    ...
    _defineProperty$1(this, "trapFocus", function (event) {
      ...
      if (browser.isIos || !_this22.active || event.key !== 'Tab' || event.keyCode !== 9) {
        return;
      } // Get the current focused element


      var focused = document.activeElement;
      var focusable = getElements.call(_this22.player, 'a[href], button:not(:disabled), input:not(:disabled), [tabindex]');
    ...
    _defineProperty$1(this, "update", function () {
      if (_this22.enabled) {
        ...
        _this22.player.debug.log("".concat(mode, " fullscreen enabled"));
      } else {
        _this22.player.debug.log('Fullscreen not supported and fallback disabled');
      } // Add styling hook to show button


      toggleClass(_this22.player.elements.container, _this22.player.config.classNames.fullscreen.enabled, _this22.enabled);
    });
    ...
    _defineProperty$1(this, "enter", function () {
      ...
      if (browser.isIos && _this22.player.config.fullscreen.iosNative) {
        if (_this22.player.isVimeo) {
        ...
        _this22.toggleFallback(true);
      } else if (!_this22.prefix) {
        _this22.target.requestFullscreen({
          navigationUI: 'hide'
        });
      } else if (!is.empty(_this22.prefix)) {
        _this22.target["".concat(_this22.prefix, "Request").concat(_this22.property)]();
      }
    });
    ...
    _defineProperty$1(this, "exit", function () {
      ...
      if (browser.isIos && _this22.player.config.fullscreen.iosNative) {
        ...
        _this22.toggleFallback(false);
      } else if (!_this22.prefix) {
        (document.cancelFullScreen || document.exitFullscreen).call(document);
      } else if (!is.empty(_this22.prefix)) {
        var action = _this22.prefix === 'moz' ? 'Cancel' : 'Exit';
        document["".concat(_this22.prefix).concat(action).concat(_this22.property)]();
      }
    });
    ...
    on.call(this.player, this.player.elements.container, 'dblclick', function (event) {
      ...
      if (is.element(_this22.player.elements.controls) && _this22.player.elements.controls.contains(event.target)) {
        return;
      }

      _this22.player.listeners.proxy(event, _this22.toggle, 'fullscreen');
    }); // Tap focus when in fullscreen

    on.call(this, this.player.elements.container, 'keydown', function (event) {
      return _this22.trapFocus(event);
    }); // Update the UI
...
var ui = {
  ...
  setPoster: function setPoster(poster) {
    ...
    .then(function () {
      ...
      if (poster === _this24.poster) {
        ui.togglePoster.call(_this24, false);
      } // Rethrow
      ...
      ui.togglePoster.call(_this24, true);
      return poster;
    });
  },
  // Check playing state
  checkPlaying: function checkPlaying(event) {
    ...
    Array.from(this.elements.buttons.play || []).forEach(function (target) {
      Object.assign(target, {
        pressed: _this25.playing
      });
      target.setAttribute('aria-label', i18n.get(_this25.playing ? 'pause' : 'play', _this25.config));
  ...
  checkLoading: function checkLoading(event) {
    ...
    this.timers.loading = setTimeout(function () {
      ...
      toggleClass(_this26.elements.container, _this26.config.classNames.loading, _this26.loading); // Update controls visibility
  ...
  migrateStyles: function migrateStyles() {
    ...
    .filter(function (key) {
      ...
      _this27.elements.container.style.setProperty(key, _this27.media.style.getPropertyValue(key)); // Clean up from media element


      _this27.media.style.removeProperty(key);
...
var Listeners = /*#__PURE__*/function () {
  function Listeners(_player) {
    ...
    _defineProperty$1(this, "setTabFocus", function (event) {
      var player = _this28.player;
      var elements = player.elements;
      clearTimeout(_this28.focusTimer); // Ignore any key other than tab
      ...
      if (event.type === 'keydown') {
        _this28.lastKeyDown = event.timeStamp;
      ...
      var wasKeyDown = event.timeStamp - _this28.lastKeyDown <= 20; // Ignore focus events if a key was pressed prior
    ...
    _defineProperty$1(this, "global", function () {
      ...
      var player = _this28.player; // Keyboard shortcuts

      if (player.config.keyboard.global) {
        toggleListener.call(player, window, 'keydown keyup', _this28.handleKey, toggle, false);
      } // Click anywhere closes menu


      toggleListener.call(player, document.body, 'click', _this28.toggleMenu, toggle); // Detect touch by events

      once.call(player, document.body, 'touchstart', _this28.firstTouch); // Tab focus detection

      toggleListener.call(player, document.body, 'keydown focus blur focusout', _this28.setTabFocus, toggle, false, true);
    });
    ...
    _defineProperty$1(this, "container", function () {
      ...
      if (!config.keyboard.global && config.keyboard.focused) {
        on.call(player, elements.container, 'keydown keyup', _this28.handleKey, false);
      ...
      on.call(player, elements.container, 'enterfullscreen exitfullscreen', function (event) {
        var target = player.fullscreen.target; // Ignore events not from target
    ...
    _defineProperty$1(this, "media", function () {
      ...
      if (player.supported.ui && player.config.clickToPlay && !player.isAudio) {
        ...
        on.call(player, elements.container, 'click', function (event) {
          ...
          if (player.ended) {
            _this28.proxy(event, player.restart, 'restart');

            _this28.proxy(event, function () {
              silencePromise(player.play());
            }, 'play');
          } else {
            _this28.proxy(event, function () {
    ...
    _defineProperty$1(this, "bind", function (element, type, defaultHandler, customHandlerKey) {
      ...
      on.call(player, element, type, function (event) {
        return _this28.proxy(event, defaultHandler, customHandlerKey);
    ...
    _defineProperty$1(this, "controls", function () {
      ...
      if (elements.buttons.play) {
        Array.from(elements.buttons.play).forEach(function (button) {
          _this28.bind(button, 'click', function () {
            silencePromise(player.togglePlay());
          }, 'play');
        });
      } // Pause
      ...
      _this28.bind(elements.buttons.restart, 'click', player.restart, 'restart'); // Rewind


      _this28.bind(elements.buttons.rewind, 'click', function () {
      ...
      _this28.bind(elements.buttons.fastForward, 'click', function () {
      ...
      _this28.bind(elements.buttons.mute, 'click', function () {
        player.muted = !player.muted;
      }, 'mute'); // Captions toggle


      _this28.bind(elements.buttons.captions, 'click', function () {
        return player.toggleCaptions();
      }); // Download


      _this28.bind(elements.buttons.download, 'click', function () {
        triggerEvent.call(player, player.media, 'download');
      }, 'download'); // Fullscreen toggle


      _this28.bind(elements.buttons.fullscreen, 'click', function () {
        player.fullscreen.toggle();
      }, 'fullscreen'); // Picture-in-Picture


      _this28.bind(elements.buttons.pip, 'click', function () {
        player.pip = 'toggle';
      }, 'pip'); // Airplay


      _this28.bind(elements.buttons.airplay, 'click', player.airplay, 'airplay'); // Settings menu - click toggle


      _this28.bind(elements.buttons.settings, 'click', function (event) {
      ...
      _this28.bind(elements.buttons.settings, 'keyup', function (event) {
      ...
      _this28.bind(elements.settings.menu, 'keydown', function (event) {
        if (event.which === 27) {
          controls.toggleMenu.call(player, event);
        }
      ...
      _this28.bind(elements.inputs.seek, 'mousedown mousemove', function (event) {
      ...
      _this28.bind(elements.inputs.seek, 'mousedown mouseup keydown keyup touchstart touchend', function (event) {
      ...
      if (browser.isIos) {
        ...
        Array.from(inputs).forEach(function (input) {
          return _this28.bind(input, inputEvent, function (event) {
      ...
      _this28.bind(elements.inputs.seek, inputEvent, function (event) {
      ...
      _this28.bind(elements.progress, 'mouseenter mouseleave mousemove', function (event) {
        return controls.updateSeekTooltip.call(player, event);
      }); // Preview thumbnails plugin
      // TODO: Really need to work on some sort of plug-in wide event bus or pub-sub for this


      _this28.bind(elements.progress, 'mousemove touchmove', function (event) {
      ...
      _this28.bind(elements.progress, 'mouseleave touchend click', function () {
        var previewThumbnails = player.previewThumbnails;
      ...
      _this28.bind(elements.progress, 'mousedown touchstart', function (event) {
        var previewThumbnails = player.previewThumbnails;
      ...
      _this28.bind(elements.progress, 'mouseup touchend', function (event) {
        var previewThumbnails = player.previewThumbnails;
      ...
      if (browser.isWebkit) {
        Array.from(getElements.call(player, 'input[type="range"]')).forEach(function (element) {
          _this28.bind(element, 'input', function (event) {
      ...
      if (player.config.toggleInvert && !is.element(elements.display.duration)) {
        _this28.bind(elements.display.currentTime, 'click', function () {
      ...
      _this28.bind(elements.inputs.volume, inputEvent, function (event) {
        player.volume = event.target.value;
      }, 'volume'); // Update controls.hover state (used for ui.toggleControls to avoid hiding when interacting)


      _this28.bind(elements.controls, 'mouseenter mouseleave', function (event) {
      ...
      if (elements.fullscreen) {
        Array.from(elements.fullscreen.children).filter(function (c) {
          ...
          _this28.bind(child, 'mouseenter mouseleave', function (event) {
            elements.controls.hover = !player.touch && event.type === 'mouseenter';
          });
        });
      ...
      _this28.bind(elements.controls, 'mousedown mouseup touchstart touchend touchcancel', function (event) {
        elements.controls.pressed = ['mousedown', 'touchstart'].includes(event.type);
      }); // Show controls when they receive focus (e.g., when using keyboard tab key)


      _this28.bind(elements.controls, 'focusin', function () {
        var config = player.config,
        ...
        var delay = _this28.touch ? 3000 : 4000; // Clear timer
      ...
      _this28.bind(elements.inputs.volume, 'wheel', function (event) {
...
var vimeo = {
  ...
  ready: function ready() {
    ...
    player.embed.on('cuechange', function (_ref15) {
      var _ref15$cues = _ref15.cues,
          cues = _ref15$cues === void 0 ? [] : _ref15$cues;
  ...
  setup: function setup() {
    ...
    if (is.object(window.YT) && is.function(window.YT.Player)) {
      ...
      window.onYouTubeIframeAPIReady = function () {
        ...
        youtube.ready.call(_this30);
      }; // Load the SDK


      loadScript(this.config.urls.youtube.sdk).catch(function (error) {
        _this30.debug.warn('YouTube API failed to load', error);
      });
    }
  },
  // Get the media title
  getTitle: function getTitle(videoId) {
    ...
    fetch(url).then(function (data) {
      if (is.object(data)) {
        ...
        _this31.config.title = title;
        ui.setTitle.call(_this31); // Set aspect ratio

        _this31.embed.ratio = roundAspectRatio(width, height);
      }
  ...
  function Ads(player) {
    ...
    _defineProperty$1(this, "load", function () {
      ...
      if (!is.object(window.google) || !is.object(window.google.ima)) {
        loadScript(_this32.player.config.urls.googleIMA.sdk).then(function () {
          _this32.ready();
        }).catch(function () {
          // Script failed to load or is blocked
          _this32.trigger('error', new Error('Google IMA SDK failed to load'));
        });
      } else {
        _this32.ready();
      }
    ...
    _defineProperty$1(this, "ready", function () {
      ...
      _this32.startSafetyTimer(12000, 'ready()'); // Clear the safety timer
      ...
      _this32.listeners(); // Setup the IMA SDK
    ...
    _defineProperty$1(this, "setupIMA", function () {
      ...
      _this32.player.elements.container.appendChild(_this32.elements.container); // So we can run VPAID2


      google.ima.settings.setVpaidMode(google.ima.ImaSdkSettings.VpaidMode.ENABLED); // Set language

      google.ima.settings.setLocale(_this32.player.config.ads.language); // Set playback for iOS10+

      google.ima.settings.setDisableCustomPlaybackForIOS10Plus(_this32.player.config.playsinline); // We assume the adContainer is the video container of the plyr element that will house the ads

      _this32.elements.displayContainer = new google.ima.AdDisplayContainer(_this32.elements.container, _this32.player.media); // Create ads loader

      _this32.loader = new google.ima.AdsLoader(_this32.elements.displayContainer); // Listen and respond to ads loaded and error events

      _this32.loader.addEventListener(google.ima.AdsManagerLoadedEvent.Type.ADS_MANAGER_LOADED, function (event) {
        return _this32.onAdsManagerLoaded(event);
      }, false);

      _this32.loader.addEventListener(google.ima.AdErrorEvent.Type.AD_ERROR, function (error) {
        return _this32.onAdError(error);
    ...
    _defineProperty$1(this, "requestAds", function () {
      var container = _this32.player.elements.container;

      try {
        // Request video ads
        var request = new google.ima.AdsRequest();
        request.adTagUrl = _this32.tagUrl; // Specify the linear and nonlinear slot sizes. This helps the SDK
        ...
        request.setAdWillPlayMuted(!_this32.player.muted);

        _this32.loader.requestAds(request);
      } catch (e) {
        _this32.onAdError(e);
      }
    });
    ...
    _defineProperty$1(this, "pollCountdown", function () {
      ...
      if (!start) {
        ...
        _this32.elements.container.removeAttribute('data-badge-text');

        return;
      }

      var update = function update() {
        var time = _formatTime(Math.max(_this32.manager.getRemainingTime(), 0));

        var label = "".concat(i18n.get('advertisement', _this32.player.config), " - ").concat(time);

        _this32.elements.container.setAttribute('data-badge-text', label);
      };

      _this32.countdownTimer = setInterval(update, 100);
    });
    ...
    _defineProperty$1(this, "onAdsManagerLoaded", function (event) {
      ...
      _this32.manager = event.getAdsManager(_this32.player, settings); // Get the cue points for any mid-rolls by filtering out the pre- and post-roll

      _this32.cuePoints = _this32.manager.getCuePoints(); // Add listeners to the required events
      // Advertisement error events

      _this32.manager.addEventListener(google.ima.AdErrorEvent.Type.AD_ERROR, function (error) {
        return _this32.onAdError(error);
      }); // Advertisement regular events


      Object.keys(google.ima.AdEvent.Type).forEach(function (type) {
        _this32.manager.addEventListener(google.ima.AdEvent.Type[type], function (e) {
    ...
    _defineProperty$1(this, "addCuePoints", function () {
      ...
      if (!is.empty(_this32.cuePoints)) {
        _this32.cuePoints.forEach(function (cuePoint) {
          if (cuePoint !== 0 && cuePoint !== -1 && cuePoint < _this32.player.duration) {
            var seekElement = _this32.player.elements.progress;

            if (is.element(seekElement)) {
              var cuePercentage = 100 / _this32.player.duration * cuePoint;
    ...
    _defineProperty$1(this, "onAdEvent", function (event) {
      var container = _this32.player.elements.container; // Retrieve the ad from the event. Some events (e.g. ALL_ADS_COMPLETED)
      ...
      var dispatchEvent = function dispatchEvent(type) {
        triggerEvent.call(_this32.player, _this32.player.media, "ads".concat(type.replace(/_/g, '').toLowerCase()));
      }; // Bubble the event
      ...
      switch (event.type) {
        case google.ima.AdEvent.Type.LOADED:
          ...
          _this32.trigger('loaded'); // Start countdown


          _this32.pollCountdown(true);
        ...
        case google.ima.AdEvent.Type.CONTENT_RESUME_REQUESTED:
          ...
          // or collapses
          _this32.pollCountdown();

          _this32.resumeContent();

          break;

        case google.ima.AdEvent.Type.LOG:
          if (adData.adError) {
            _this32.player.debug.warn("Non-fatal ad error: ".concat(adData.adError.getMessage()));
          }
    ...
    _defineProperty$1(this, "onAdError", function (event) {
      ...
      _this32.player.debug.warn('Ads error', event);
    });
    ...
    _defineProperty$1(this, "listeners", function () {
      ...
      _this32.player.on('timeupdate', function () {
        time = _this32.player.currentTime;
      });

      _this32.player.on('seeked', function () {
        var seekedTime = _this32.player.currentTime;

        if (is.empty(_this32.cuePoints)) {
          return;
        }

        _this32.cuePoints.forEach(function (cuePoint, index) {
          if (time < cuePoint && cuePoint < seekedTime) {
            _this32.manager.discardAdBreak();

            _this32.cuePoints.splice(index, 1);
          }
        });
      ...
      window.addEventListener('resize', function () {
        if (_this32.manager) {
          _this32.manager.resize(container.offsetWidth, container.offsetHeight, google.ima.ViewMode.NORMAL);
        }
      });
    });
    ...
    _defineProperty$1(this, "play", function () {
      ...
      _this32.managerPromise.then(function () {
        // Set volume to match player
        _this32.manager.setVolume(_this32.player.volume); // Initialize the container. Must be done via a user action on mobile devices
        ...
        try {
          if (!_this32.initialized) {
            ...
            _this32.manager.init(container.offsetWidth, container.offsetHeight, google.ima.ViewMode.NORMAL); // Call play to start showing the ad. Single video and overlay ads will
    ...
    _defineProperty$1(this, "resumeContent", function () {
      ...
      _this32.elements.container.style.zIndex = ''; // Ad is stopped

      _this32.playing = false; // Play video
    ...
    _defineProperty$1(this, "pauseContent", function () {
      ...
      _this32.elements.container.style.zIndex = 3; // Ad is playing

      _this32.playing = true; // Pause our video.
    ...
    _defineProperty$1(this, "cancel", function () {
      ...
      _this32.trigger('error'); // Re-create our adsManager
    ...
    _defineProperty$1(this, "loadAds", function () {
      ...
      _this32.managerPromise.then(function () {
        // Destroy our adsManager
        if (_this32.manager) {
          _this32.manager.destroy();
        } // Re-set our adsManager promises


        _this32.managerPromise = new Promise(function (resolve) {
          _this32.on('loaded', resolve);

          _this32.player.debug.log(_this32.manager);
        }); // Now that the manager has been destroyed set it to also be un-initialized

        _this32.initialized = false; // Now request some new advertisements
    ...
    _defineProperty$1(this, "trigger", function (event) {
      ...
      var handlers = _this32.events[event];

      if (is.array(handlers)) {
        handlers.forEach(function (handler) {
          if (is.function(handler)) {
            handler.apply(_this32, args);
          }
        });
      }
    });
    ...
    _defineProperty$1(this, "on", function (event, callback) {
      if (!is.array(_this32.events[event])) {
        _this32.events[event] = [];
      }

      _this32.events[event].push(callback);

      return _this32;
    });

    _defineProperty$1(this, "startSafetyTimer", function (time, from) {
      _this32.player.debug.log("Safety timer invoked from: ".concat(from));
    ...
    _defineProperty$1(this, "clearSafetyTimer", function (from) {
      if (!is.nullOrUndefined(_this32.safetyTimer)) {
        _this32.player.debug.log("Safety timer cleared from: ".concat(from));
    ...
    this.managerPromise = new Promise(function (resolve, reject) {
      ...
      _this32.on('loaded', resolve); // Ads failed


      _this32.on('error', reject);
    });
    this.load();
  }
...
var PreviewThumbnails = /*#__PURE__*/function () {
  ...
  function PreviewThumbnails(player) {
    ...
    _defineProperty$1(this, "load", function () {
      ...
      if (_this33.player.elements.display.seekTooltip) {
        _this33.player.elements.display.seekTooltip.hidden = _this33.enabled;
      }
      ...
      _this33.getThumbnails().then(function () {
        ...
        _this33.render(); // Check to see if thumb container size was specified manually in CSS
    ...
    _defineProperty$1(this, "getThumbnails", function () {
      return new Promise(function (resolve) {
        var src = _this33.player.config.previewThumbnails.src;
        ...
        var sortAndResolve = function sortAndResolve() {
          ...
          _this33.thumbnails.sort(function (x, y) {
            return x.height - y.height;
          });

          _this33.player.debug.log('Preview thumbnails', _this33.thumbnails);
      ...
      return new Promise(function (resolve) {
        fetch(url).then(function (response) {
          ...
          tempImage.onload = function () {
            ...
            _this33.thumbnails.push(thumbnail);
    ...
    _defineProperty$1(this, "startMove", function (event) {
      ...
      if (!_this33.player.media.duration) {
        return;
      }

      if (event.type === 'touchmove') {
        // Calculate seek hover position as approx video seconds
        _this33.seekTime = _this33.player.media.duration * (_this33.player.elements.inputs.seek.value / 100);
      } else {
        // Calculate seek hover position as approx video seconds
        var clientRect = _this33.player.elements.progress.getBoundingClientRect();

        var percentage = 100 / clientRect.width * (event.pageX - clientRect.left);
        _this33.seekTime = _this33.player.media.duration * (percentage / 100);

        if (_this33.seekTime < 0) {
          // The mousemove fires for 10+px out to the left
          _this33.seekTime = 0;
        }

        if (_this33.seekTime > _this33.player.media.duration - 1) {
          // Took 1 second off the duration for safety, because different players can disagree on the real duration of a video
          _this33.seekTime = _this33.player.media.duration - 1;
        }

        _this33.mousePosX = event.pageX; // Set time text inside image container

        _this33.elements.thumb.time.innerText = _formatTime(_this33.seekTime);
    ...
    _defineProperty$1(this, "endMove", function () {
      _this33.toggleThumbContainer(false, true);
    });

    _defineProperty$1(this, "startScrubbing", function (event) {
      // Only act on left mouse button (0), or touch device (event.button does not exist or is false)
      if (is.nullOrUndefined(event.button) || event.button === false || event.button === 0) {
        _this33.mouseDown = true; // Wait until media has a duration

        if (_this33.player.media.duration) {
          _this33.toggleScrubbingContainer(true);

          _this33.toggleThumbContainer(false, true); // Download and show image
    ...
    _defineProperty$1(this, "endScrubbing", function () {
      _this33.mouseDown = false; // Hide scrubbing preview. But wait until the video has successfully seeked before hiding the scrubbing preview

      if (Math.ceil(_this33.lastTime) === Math.ceil(_this33.player.media.currentTime)) {
        // The video was already seeked/loaded at the chosen time - hide immediately
        _this33.toggleScrubbingContainer(false);
      } else {
        // The video hasn't seeked yet. Wait for that
        once.call(_this33.player, _this33.player.media, 'timeupdate', function () {
          // Re-check mousedown - we might have already started scrubbing again
          if (!_this33.mouseDown) {
            _this33.toggleScrubbingContainer(false);
          }
        });
      }
    ...
    _defineProperty$1(this, "listeners", function () {
      ...
      _this33.player.on('seeked', function () {
        _this33.toggleThumbContainer(false);
      });
    ...
    _defineProperty$1(this, "render", function () {
      ...
      _this33.elements.thumb.container = createElement('div', {
        class: _this33.player.config.classNames.previewThumbnails.thumbContainer
      }); // Wrapper for the image for styling

      _this33.elements.thumb.imageContainer = createElement('div', {
        class: _this33.player.config.classNames.previewThumbnails.imageContainer
      });

      _this33.elements.thumb.container.appendChild(_this33.elements.thumb.imageContainer); // Create HTML element, parent+span: time text (e.g., 01:32:00)


      var timeContainer = createElement('div', {
        class: _this33.player.config.classNames.previewThumbnails.timeContainer
      });
      _this33.elements.thumb.time = createElement('span', {}, '00:00');
      timeContainer.appendChild(_this33.elements.thumb.time);

      _this33.elements.thumb.container.appendChild(timeContainer); // Inject the whole thumb


      if (is.element(_this33.player.elements.progress)) {
        _this33.player.elements.progress.appendChild(_this33.elements.thumb.container);
      } // Create HTML element: plyr__preview-scrubbing-container


      _this33.elements.scrubbing.container = createElement('div', {
        class: _this33.player.config.classNames.previewThumbnails.scrubbingContainer
      });

      _this33.player.elements.wrapper.appendChild(_this33.elements.scrubbing.container);
    });

    _defineProperty$1(this, "destroy", function () {
      if (_this33.elements.thumb.container) {
        _this33.elements.thumb.container.remove();
      }

      if (_this33.elements.scrubbing.container) {
    ...
    _defineProperty$1(this, "showImageAtCurrentTime", function () {
      ...
      var thumbNum = _this33.thumbnails[0].frames.findIndex(function (frame) {
        return _this33.seekTime >= frame.startTime && _this33.seekTime <= frame.endTime;
      });
      ...
      if (!_this33.mouseDown) {
        _this33.toggleThumbContainer(hasThumb);
      ...
      _this33.thumbnails.forEach(function (thumbnail, index) {
        if (_this33.loadedImages.includes(thumbnail.frames[thumbNum].text)) {
          qualityIndex = index;
        }
      }); // Only proceed if either thumbnum or thumbfilename has changed


      if (thumbNum !== _this33.showingThumb) {
        _this33.showingThumb = thumbNum;

        _this33.loadImage(qualityIndex);
      }
    });

    _defineProperty$1(this, "loadImage", function () {
      var qualityIndex = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 0;
      var thumbNum = _this33.showingThumb;
      var thumbnail = _this33.thumbnails[qualityIndex];
      var urlPrefix = thumbnail.urlPrefix;
      var frame = thumbnail.frames[thumbNum];
      var thumbFilename = thumbnail.frames[thumbNum].text;
      var thumbUrl = urlPrefix + thumbFilename;

      if (!_this33.currentImageElement || _this33.currentImageElement.dataset.filename !== thumbFilename) {
        // If we're already loading a previous image, remove its onload handler - we don't want it to load after this one
        // Only do this if not using sprites. Without sprites we really want to show as many images as possible, as a best-effort
        if (_this33.loadingImage && _this33.usingSprites) {
        ...
        _this33.showingThumbFilename = thumbFilename;

        _this33.player.debug.log("Loading image: ".concat(thumbUrl)); // For some reason, passing the named function directly causes it to execute immediately. So I've wrapped it in an anonymous function...


        previewImage.onload = function () {
          return _this33.showImage(previewImage, frame, qualityIndex, thumbNum, thumbFilename, true);
        };

        _this33.loadingImage = previewImage;

        _this33.removeOldImages(previewImage);
      } else {
        // Update the existing image
        _this33.showImage(_this33.currentImageElement, frame, qualityIndex, thumbNum, thumbFilename, false);

        _this33.currentImageElement.dataset.index = thumbNum;
    ...
    _defineProperty$1(this, "showImage", function (previewImage, frame, qualityIndex, thumbNum, thumbFilename) {
      ...
      _this33.player.debug.log("Showing thumb: ".concat(thumbFilename, ". num: ").concat(thumbNum, ". qual: ").concat(qualityIndex, ". newimg: ").concat(newImage));

      _this33.setImageSizeAndOffset(previewImage, frame);

      if (newImage) {
        _this33.currentImageContainer.appendChild(previewImage);

        _this33.currentImageElement = previewImage;

        if (!_this33.loadedImages.includes(thumbFilename)) {
          _this33.loadedImages.push(thumbFilename);
        }
      ...
      _this33.preloadNearby(thumbNum, true).then(_this33.preloadNearby(thumbNum, false)).then(_this33.getHigherQuality(qualityIndex, previewImage, frame, thumbFilename));
    });

    _defineProperty$1(this, "removeOldImages", function (currentImage) {
      // Get a list of all images, convert it from a DOM list to an array
      Array.from(_this33.currentImageContainer.children).forEach(function (image) {
        if (image.tagName.toLowerCase() !== 'img') {
          return;
        }

        var removeDelay = _this33.usingSprites ? 500 : 1000;
        ...
        if (image.dataset.index !== currentImage.dataset.index && !image.dataset.deleting) {
          ...
          var currentImageContainer = _this33.currentImageContainer;
          setTimeout(function () {
            currentImageContainer.removeChild(image);

            _this33.player.debug.log("Removing thumb: ".concat(image.dataset.filename));
          }, removeDelay);
        }
      });
    });
    ...
    _defineProperty$1(this, "preloadNearby", function (thumbNum) {
      ...
      return new Promise(function (resolve) {
        setTimeout(function () {
          var oldThumbFilename = _this33.thumbnails[0].frames[thumbNum].text;

          if (_this33.showingThumbFilename === oldThumbFilename) {
            // Find the nearest thumbs with different filenames. Sometimes it'll be the next index, but in the case of sprites, it might be 100+ away
            var thumbnailsClone;

            if (forward) {
              thumbnailsClone = _this33.thumbnails[0].frames.slice(thumbNum);
            } else {
              thumbnailsClone = _this33.thumbnails[0].frames.slice(0, thumbNum).reverse();
            }
            ...
            thumbnailsClone.forEach(function (frame) {
              ...
              if (newThumbFilename !== oldThumbFilename) {
                ...
                if (!_this33.loadedImages.includes(newThumbFilename)) {
                  foundOne = true;

                  _this33.player.debug.log("Preloading thumb filename: ".concat(newThumbFilename));

                  var urlPrefix = _this33.thumbnails[0].urlPrefix;
                  var thumbURL = urlPrefix + newThumbFilename;
                  var previewImage = new Image();
                  previewImage.src = thumbURL;

                  previewImage.onload = function () {
                    _this33.player.debug.log("Preloaded thumb filename: ".concat(newThumbFilename));

                    if (!_this33.loadedImages.includes(newThumbFilename)) _this33.loadedImages.push(newThumbFilename); // We don't resolve until the thumb is loaded
    ...
    _defineProperty$1(this, "getHigherQuality", function (currentQualityIndex, previewImage, frame, thumbFilename) {
      if (currentQualityIndex < _this33.thumbnails.length - 1) {
        // Only use the higher quality version if it's going to look any better - if the current thumb is of a lower pixel density than the thumbnail container
        var previewImageHeight = previewImage.naturalHeight;

        if (_this33.usingSprites) {
          previewImageHeight = frame.h;
        }

        if (previewImageHeight < _this33.thumbContainerHeight) {
          // Recurse back to the loadImage function - show a higher quality one, but only if the viewer is on this frame for a while
          setTimeout(function () {
            // Make sure the mouse hasn't already moved on and started hovering at another image
            if (_this33.showingThumbFilename === thumbFilename) {
              _this33.player.debug.log("Showing higher quality thumb for: ".concat(thumbFilename));

              _this33.loadImage(currentQualityIndex + 1);
            }
          }, 300);
        }
      }
    ...
    _defineProperty$1(this, "toggleThumbContainer", function () {
      ...
      var className = _this33.player.config.classNames.previewThumbnails.thumbContainerShown;

      _this33.elements.thumb.container.classList.toggle(className, toggle);
    ...
    _defineProperty$1(this, "toggleScrubbingContainer", function () {
      var toggle = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : false;
      var className = _this33.player.config.classNames.previewThumbnails.scrubbingContainerShown;

      _this33.elements.scrubbing.container.classList.toggle(className, toggle);
    ...
    _defineProperty$1(this, "determineContainerAutoSizing", function () {
      if (_this33.elements.thumb.imageContainer.clientHeight > 20 || _this33.elements.thumb.imageContainer.clientWidth > 20) {
        // This will prevent auto sizing in this.setThumbContainerSizeAndPos()
        _this33.sizeSpecifiedInCSS = true;
      }
    });

    _defineProperty$1(this, "setThumbContainerSizeAndPos", function () {
      if (!_this33.sizeSpecifiedInCSS) {
        var thumbWidth = Math.floor(_this33.thumbContainerHeight * _this33.thumbAspectRatio);
        _this33.elements.thumb.imageContainer.style.height = "".concat(_this33.thumbContainerHeight, "px");
        _this33.elements.thumb.imageContainer.style.width = "".concat(thumbWidth, "px");
      } else if (_this33.elements.thumb.imageContainer.clientHeight > 20 && _this33.elements.thumb.imageContainer.clientWidth < 20) {
        var _thumbWidth = Math.floor(_this33.elements.thumb.imageContainer.clientHeight * _this33.thumbAspectRatio);

        _this33.elements.thumb.imageContainer.style.width = "".concat(_thumbWidth, "px");
      } else if (_this33.elements.thumb.imageContainer.clientHeight < 20 && _this33.elements.thumb.imageContainer.clientWidth > 20) {
        var thumbHeight = Math.floor(_this33.elements.thumb.imageContainer.clientWidth / _this33.thumbAspectRatio);
        _this33.elements.thumb.imageContainer.style.height = "".concat(thumbHeight, "px");
      }
    ...
    _defineProperty$1(this, "setThumbContainerPos", function () {
      var seekbarRect = _this33.player.elements.progress.getBoundingClientRect();

      var plyrRect = _this33.player.elements.container.getBoundingClientRect();

      var container = _this33.elements.thumb.container; // Find the lowest and highest desired left-position, so we don't slide out the side of the video container

      var minVal = plyrRect.left - seekbarRect.left + 10;
      var maxVal = plyrRect.right - seekbarRect.left - container.clientWidth - 10; // Set preview container position to: mousepos, minus seekbar.left, minus half of previewContainer.clientWidth

      var previewPos = _this33.mousePosX - seekbarRect.left - container.clientWidth / 2;
    ...
    _defineProperty$1(this, "setScrubbingContainerSize", function () {
      ...
      _this33.elements.scrubbing.container.style.width = "".concat(width, "px");
      _this33.elements.scrubbing.container.style.height = "".concat(height, "px");
    });
    ...
    _defineProperty$1(this, "setImageSizeAndOffset", function (previewImage, frame) {
      ...
      var multiplier = _this33.thumbContainerHeight / frame.h; // eslint-disable-next-line no-param-reassign
...
var source = {
  ...
  insertElements: function insertElements(type, attributes) {
    ...
    if (is.string(attributes)) {
      ...
      attributes.forEach(function (attribute) {
        insertElement(type, _this34.media, attribute);
      });
    }
  },
  // Update source
  ...
  change: function change(input) {
    ...
    this.destroy.call(this, function () {
      ...
      _this35.options.quality = []; // Remove elements

      removeElement(_this35.media);
      _this35.media = null; // Reset class name

      if (is.element(_this35.elements.container)) {
      ...
      Object.assign(_this35, {
        ...
        type: type,
        // Check for support
        supported: support.check(type, provider, _this35.config.playsinline),
        // Create new element
        media: createElement(tagName, attributes)
      }); // Inject the new element

      _this35.elements.container.appendChild(_this35.media); // Autoplay the new source?


      if (is.boolean(input.autoplay)) {
        _this35.config.autoplay = input.autoplay;
      } // Set attributes for audio and video


      if (_this35.isHTML5) {
        if (_this35.config.crossorigin) {
          _this35.media.setAttribute('crossorigin', '');
        }

        if (_this35.config.autoplay) {
          _this35.media.setAttribute('autoplay', '');
        }

        if (!is.empty(input.poster)) {
          _this35.poster = input.poster;
        }

        if (_this35.config.loop.active) {
          _this35.media.setAttribute('loop', '');
        }

        if (_this35.config.muted) {
          _this35.media.setAttribute('muted', '');
        }

        if (_this35.config.playsinline) {
          _this35.media.setAttribute('playsinline', '');
        }
      } // Restore class hook


      ui.addStyleHook.call(_this35); // Set new sources for html5

      if (_this35.isHTML5) {
        source.insertElements.call(_this35, 'source', sources);
      } // Set video title


      _this35.config.title = input.title; // Set up from scratch

      media.setup.call(_this35); // HTML5 stuff

      if (_this35.isHTML5) {
        // Setup captions
        if (Object.keys(input).includes('tracks')) {
          source.insertElements.call(_this35, 'track', input.tracks);
        }
      } // If HTML5 or embed but not fully supported, setupInterface and call ready now


      if (_this35.isHTML5 || _this35.isEmbed && !_this35.supported.ui) {
        // Setup interface
      ...
      if (!is.empty(input.previewThumbnails)) {
        Object.assign(_this35.config.previewThumbnails, input.previewThumbnails); // Cleanup previewThumbnails plugin if it was loaded

        if (_this35.previewThumbnails && _this35.previewThumbnails.loaded) {
        ...
        if (_this35.config.previewThumbnails.enabled) {
          _this35.previewThumbnails = new PreviewThumbnails(_this35);
        }
...
var Plyr = /*#__PURE__*/function () {
  function Plyr(target, options) {
    ...
    _defineProperty$1(this, "play", function () {
      if (!is.function(_this36.media.play)) {
        return null;
      } // Intecept play with ads


      if (_this36.ads && _this36.ads.enabled) {
        _this36.ads.managerPromise.then(function () {
      ...
      return _this36.media.play();
    });

    _defineProperty$1(this, "pause", function () {
      if (!_this36.playing || !is.function(_this36.media.pause)) {
        return null;
      }

      return _this36.media.pause();
    });

    _defineProperty$1(this, "togglePlay", function (input) {
      // Toggle based on current state if nothing passed
      var toggle = is.boolean(input) ? input : !_this36.playing;

      if (toggle) {
        return _this36.play();
      }

      return _this36.pause();
    });
    ...
    _defineProperty$1(this, "stop", function () {
      if (_this36.isHTML5) {
        ...
        _this36.restart();
      } else if (is.function(_this36.media.stop)) {
        _this36.media.stop();
      }
    });
    ...
    _defineProperty$1(this, "rewind", function (seekTime) {
      _this36.currentTime -= is.number(seekTime) ? seekTime : _this36.config.seekTime;
    });
    ...
    _defineProperty$1(this, "increaseVolume", function (step) {
      var volume = _this36.media.muted ? 0 : _this36.volume;
      _this36.volume = volume + (is.number(step) ? step : 0);
    });

    _defineProperty$1(this, "decreaseVolume", function (step) {
      _this36.increaseVolume(-step);
    });
    ...
    _defineProperty$1(this, "toggleControls", function (toggle) {
      ...
      if (_this36.supported.ui && !_this36.isAudio) {
        ...
        var isHidden = hasClass(_this36.elements.container, _this36.config.classNames.hideControls); // Negate the argument if not undefined since adding the class to hides the controls

        var force = typeof toggle === 'undefined' ? undefined : !toggle; // Apply and get updated state

        var hiding = toggleClass(_this36.elements.container, _this36.config.classNames.hideControls, force); // Close menu

        if (hiding && is.array(_this36.config.controls) && _this36.config.controls.includes('settings') && !is.empty(_this36.config.settings)) {
          controls.toggleMenu.call(_this36, false);
        } // Trigger event on change


        if (hiding !== isHidden) {
          var eventName = hiding ? 'controlshidden' : 'controlsshown';
          triggerEvent.call(_this36, _this36.media, eventName);
        }
    ...
    _defineProperty$1(this, "on", function (event, callback) {
      on.call(_this36, _this36.elements.container, event, callback);
    });

    _defineProperty$1(this, "once", function (event, callback) {
      once.call(_this36, _this36.elements.container, event, callback);
    });

    _defineProperty$1(this, "off", function (event, callback) {
      off(_this36.elements.container, event, callback);
    });
    ...
    _defineProperty$1(this, "destroy", function (callback) {
      ...
      var done = function done() {
        ...
        _this36.embed = null; // If it's a soft destroy, make minimal changes

        if (soft) {
          if (Object.keys(_this36.elements).length) {
            // Remove elements
            ...
            removeElement(_this36.elements.wrapper); // Clear for GC
          ...
          // Unbind listeners
          unbindListeners.call(_this36); // Cancel current network requests

          html5.cancelRequests.call(_this36); // Replace the container with the original element provided

          replaceElement(_this36.elements.original, _this36.elements.container); // Event

          triggerEvent.call(_this36, _this36.elements.original, 'destroyed', true); // Callback

          if (is.function(callback)) {
            callback.call(_this36.elements.original);
          } // Reset state


          _this36.ready = false; // Clear for garbage collection

          setTimeout(function () {
            _this36.elements = null;
            _this36.media = null;
          }, 200);
        }
      }; // Stop playback
      ...
      _this36.stop(); // Clear timeouts


      clearTimeout(_this36.timers.loading);
      clearTimeout(_this36.timers.controls);
      clearTimeout(_this36.timers.resized); // Provider specific stuff

      if (_this36.isHTML5) {
        // Restore native video controls
        ui.toggleNativeControls.call(_this36, true); // Clean up

        done();
      } else if (_this36.isYouTube) {
        // Clear timers
        clearInterval(_this36.timers.buffering);
        clearInterval(_this36.timers.playing); // Destroy YouTube API

        if (_this36.embed !== null && is.function(_this36.embed.destroy)) {
          _this36.embed.destroy();
        } // Clean up


        done();
      } else if (_this36.isVimeo) {
        // Destroy Vimeo API
        // then clean up (wait, to prevent postmessage errors)
        if (_this36.embed !== null) {
          _this36.embed.unload().then(done);
    ...
    _defineProperty$1(this, "supports", function (type) {
      return support.mime.call(_this36, type);
    });
    ...
    this.config = extend({}, defaults, Plyr.defaults, options || {}, function () {
      try {
        return JSON.parse(_this36.media.getAttribute('data-plyr-config'));
      } catch (e) {
        return {};
      }
    }()); // Elements cache
    ...
    if (this.config.debug) {
      on.call(this, this.elements.container, this.config.events.join(' '), function (event) {
        _this36.debug.log("event: ".concat(event.type));
      });
    } // Setup fullscreen
  ...
  _createClass(Plyr, [{
    ...
    set: function set(input) {
      ...
      setTimeout(function () {
        _this37.media.playbackRate = speed;
      }, 0);
    }
    /**
...
};exports.default=script;//# sourceMappingURL=vue-plyr.polyfilled.ssr.js.map
